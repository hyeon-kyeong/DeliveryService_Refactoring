...
<script>
	...
	function showChat(chat) {
		$("#chatbox").append(
				"<tr><td>" + chat.senderUsername + " : " + chat.content
						+ "</td></tr>");
	}
				...
				<div style="width: 500px;">
					<div class="bg-dark text-white "
						...
						<span class="align-middle"
								...
								id="receiverUsername" name="receiverUsername" class="form-control">
							...
							<input type="hidden" id="senderUsername" value="${username}">
...
<!-- 							과의 대화</span>  -->
				...
				<button id="chatSend" class="btn btn-default" type="button">Chat
					Send</button>
